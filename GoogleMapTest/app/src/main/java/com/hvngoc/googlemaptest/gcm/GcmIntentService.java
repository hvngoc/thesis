...
public class GcmIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(final String token) {
        ...
        new SendRegKeyAsyncTask().execute(token);
    }
    ...
    private class SendRegKeyAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        private Boolean postData(String regID) {
            this.regID = regID;
            ...
            String serverUrl = GLOBAL.SERVER_URL + "updateRegistrationID";
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if(result) {
                // update registrationID for current user
